...
class Torus(ThreeDScene):
    def construct(self):
        ...
        step6 = MathTex(r"\| \frac{\partial \vec{r}}{\partial s} \times \frac{\partial \vec{r}}{\partial t} \| = b(a+b\cos t)\sqrt{(\cos s \cos t)^2 + (\sin s \cos t)^2 + (\sin t)^2}").scale(0.75).next_to(step1, DOWN).align_to(equation, LEFT)
